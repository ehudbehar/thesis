...
In an ideal plasma waveguide , the radial electron density profile is parabolic:
\begin{equation}
...
\end{marginfigure}
where $N_e(r)$ is the electron density at a distance $r$ from the axis of the beam and $\Delta N_e$ is the increase in the electron density at $r=r_\text{ch}$ compared to the axial value. See figure \ref{fig:rdp_parabola}. Lacking such guiding, the interaction length is at most of the order of the Rayleigh range.
