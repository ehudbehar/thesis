...
Our method of plasma generation is based on the laser trigger technique with the injection of N\textsubscript{2} and H\textsubscript{2} gas inside the capillary \cite{Bobrova2002,Spence2001}.
...
The detector gating and delay were set by a digital delay and pulse generator board\sidenote{\textit{Stanford Research Systems}, model DG535.} that triggers the CCD camera.
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{figures/jitter/low_jitter.jpg}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{figures/jitter/multiple.PNG}
...
\end{figure}
Upon plasma discharge, we recorded the optical guiding of the \textcolor{red}{ultra-}short laser pulses, shown in \textcolor{red}{?}, and watched after the gain of the signal while it interacts with the plasma inside the capillary. The effect of gain in the optical guiding is easily seen in figure \textcolor{red}{figure}.
