...
\begin{marginfigure}
    ...
    \caption{A typical plasma discharge. Blue waveform is the current profile obtained from the Rogowsky coil. In green is the photo--diode rise up from the igniting Nd:Yag pulse.}
...
\begin{figure}
    ...
    \caption{Low jitter in consecutive capillary discharges.}
